//! PUP UI API — script-facing UI element types and fields for PUP.
//!
//! Mirrors node_api for nodes: defines what UI element types and fields scripts can use.
//! Uses the central ui_registry as the single source of truth; this module provides
//! the PUP-facing view and any PUP-specific naming (e.g. "Text" vs "UIText").

use crate::nodes::ui::ui_registry::UIElementType;
use crate::scripting::ast::Type;
use crate::structs::script_ui_registry::UI_REGISTRY;

/// PUP script name for a UI element type (e.g. "UIText", "Text").
pub fn pup_element_type_names(et: UIElementType) -> &'static [&'static str] {
    match et {
