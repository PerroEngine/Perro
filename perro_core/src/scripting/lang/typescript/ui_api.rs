//! TypeScript UI API — script-facing UI element types and fields for TypeScript.
//!
...
//! the TypeScript-facing view and any naming conventions.

use crate::nodes::ui::ui_registry::UIElementType;
use crate::scripting::ast::Type;
use crate::structs::script_ui_registry::UI_REGISTRY;

/// TypeScript script name for a UI element type (e.g. "UIText", "Text").
pub fn typescript_element_type_names(et: UIElementType) -> &'static [&'static str] {
    match et {
