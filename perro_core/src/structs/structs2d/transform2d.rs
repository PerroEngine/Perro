...
fn is_default_rotation(v: &f32) -> bool { *v == default_rotation() }
...
pub struct Transform2D {
    ...
    #[serde(default = "default_rotation",    skip_serializing_if = "is_default_rotation")]
...
impl Transform2D {
    pub fn new(pos: Vector2, rot: f32, scale: Vector2) -> Self {
        Self {position: pos, rotation: rot, scale: scale}
    }
}
