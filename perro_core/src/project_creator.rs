...
pub fn create_new_project(
    ...
    println!("\x1b[36m     • Transpile & compile scripts (for testing changes):\x1b[0m");
    println!(
        "\x1b[33m       cargo run -p perro_core -- --path {} --scripts\x1b[0m",
        project_path.display()
    );
    println!("\x1b[36m     • Build scripts and run dev project (all-in-one):\x1b[0m");
    println!(
    ...
    println!("\x1b[36m     • Or run dev project separately:\x1b[0m");
    println!(
        "\x1b[33m       cargo run -p perro_dev -- --path {}\x1b[0m",
        project_path.display()
    );
    println!("\n  Release build:");
    println!("\x1b[36m     • Build final release (compiles everything):\x1b[0m");
    println!(
        "\x1b[33m       cargo run -p perro_core -- --path {} --project\x1b[0m",
        project_path.display()
    );
    println!("\x1b[36m     • Build verbose release (with console window):\x1b[0m");
    println!(
