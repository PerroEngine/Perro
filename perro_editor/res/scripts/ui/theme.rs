...
pub const BG_WIDGET: &str = "#2A2F36"; // text boxes, buttons, dropdowns
pub const BG_WIDGET_HOVER: &str = "#323842";
pub const BG_WIDGET_PRESSED: &str = "#343A43";

// Strokes.
pub const STROKE: &str = "#343A43";
pub const STROKE_SOFT: &str = "#2F3540";
...
pub const TEXT_DIM: &str = "#A7AFB9";
pub const TEXT_FAINT: &str = "#6E7680";
