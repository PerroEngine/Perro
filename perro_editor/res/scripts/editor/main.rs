...
pub const MAX_ANIM_UNDO: usize = 64;
...
methods!({
    fn on_editor_signal(&self, ctx: &mut ScriptContext<'_, API>, sender: NodeID) {
        ...
        match name.as_str() {
            ...
            "anim_prev_key_button" => jump_anim_key(ctx, -1),
            "anim_next_key_button" => jump_anim_key(ctx, 1),
            "anim_interp_button" => cycle_anim_key_interp(ctx),
            "anim_ease_button" => cycle_anim_key_ease(ctx),
            "anim_value_box" => edit_anim_key_value_box(ctx),
            "anim_open_button" => toggle_anim_key_open(ctx),
            "anim_undo_button" => anim_undo(ctx),
            "anim_redo_button" => anim_redo(ctx),
            "anim_zoom_in_button" => zoom_anim_view(ctx, 0.5),
            "anim_zoom_out_button" => zoom_anim_view(ctx, 2.0),
            "anim_fit_button" => fit_anim_view(ctx),
            "anim_track_up_button" => scroll_anim_tracks(ctx, -1),
            "anim_track_down_button" => scroll_anim_tracks(ctx, 1),
            "asset_glb_play_button" => toggle_glb_viewer_animation(ctx),
            "asset_glb_isolate_button" => toggle_glb_viewer_isolate(ctx),
...
fn connect_editor_signals<API: ScriptAPI + ?Sized>(ctx: &mut ScriptContext<'_, API>) {
    let _ = signal_connect_many!(
        ...
        [
            ...
            signal!("editor_anim_prev_key"),
            signal!("editor_anim_next_key"),
            signal!("editor_anim_interp"),
            signal!("editor_anim_ease"),
            signal!("editor_anim_value"),
            signal!("editor_anim_open"),
            signal!("editor_anim_undo"),
            signal!("editor_anim_redo"),
            signal!("editor_anim_zoom_in"),
            signal!("editor_anim_zoom_out"),
            signal!("editor_anim_fit"),
            signal!("editor_anim_track_up"),
            signal!("editor_anim_track_down"),
            ...
            signal!("editor_asset_glb_isolate"),
