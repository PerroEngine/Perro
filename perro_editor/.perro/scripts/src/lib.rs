...
pub mod scripts_joycon_rs;
pub mod scripts_light_pup;
...
use scripts_joycon_rs::scripts_joycon_rs_create_script;
use scripts_light_pup::scripts_light_pup_create_script;
