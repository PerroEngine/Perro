...
impl Script for TypesTsScript {
    fn init(&mut self, api: &mut ScriptApi<'_>) {
        // [stripped for release] api.print(&String::from("--- START TS MEGA TEST SUITE ---"));
        ...
        // [stripped for release] api.print(&String::from("--- ALL TS TESTS COMPLETE ---"));
    }
...
impl TypesTsScript {
    ...
    fn test_dynamic_containers_ops(&mut self, api: &mut ScriptApi<'_>, external_call: bool) {
        ...
        // [stripped for release] api.print(&format!("{} {}", String::from("Dyn Array Push (decimal):"), self.dynamic_array_inferred.get((self.dynamic_array_inferred.len() - (1u32 as usize)) as usize).cloned().unwrap_or_default().as_f64().unwrap_or_default()));
        ...
        // [stripped for release] api.print(&format!("{} {}", String::from("Dyn Map Set (new_decimal):"), self.dynamic_map_inferred.get(String::from("new_decimal").as_str()).cloned().unwrap_or_default().as_f64().unwrap_or_default()));
        ...
        // [stripped for release] api.print(&format!("{} {}", String::from("Dyn Map Num Key Dec (30.5):"), dyn_map_numeric_key_decimal.get(String::from("30.5").as_str()).cloned().unwrap_or_default().as_f64().unwrap_or_default()));
    }
