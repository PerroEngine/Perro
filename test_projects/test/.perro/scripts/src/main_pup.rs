...
static VAR_GET_TABLE: phf::Map<u64, fn(&MainPupScript) -> Option<Value>> = phf::phf_map! {
        16121189368928505687u64 => |script: &MainPupScript| -> Option<Value> {
                        Some(json!(script.script_updates))
                    },
        21748447695211092u64 => |script: &MainPupScript| -> Option<Value> {
                        Some(json!(script.bob))
                    },
};

static VAR_SET_TABLE: phf::Map<u64, fn(&mut MainPupScript, Value) -> Option<()>> = phf::phf_map! {
        16121189368928505687u64 => |script: &mut MainPupScript, val: Value| -> Option<()> {
        ...
        21748447695211092u64 => |script: &mut MainPupScript, val: Value| -> Option<()> {
...
static VAR_APPLY_TABLE: phf::Map<u64, fn(&mut MainPupScript, &Value)> = phf::phf_map! {
        21748447695211092u64 => |script: &mut MainPupScript, val: &Value| {
                            if let Some(v) = val.as_str() {
                                script.bob = v.to_string();
                            }
                        },
...
static DISPATCH_TABLE: phf::Map<u64, fn(&mut MainPupScript, &[Value], &mut ScriptApi<'_>)> = phf::phf_map! {
        6114839014446982845u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_1(m, api, true);
        },
        6114835715912098212u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_2(m, api, true);
        },
        6114836815423726423u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_3(m, api, true);
        },
        6114833516888841790u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_4(m, api, true);
        },
        6114834616400470001u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_5(m, api, true);
        },
        6114831317865585368u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_6(m, api, true);
        },
        6114832417377213579u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_7(m, api, true);
        },
        6114829118842328946u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_8(m, api, true);
        },
        6114830218353957157u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_9(m, api, true);
        },
        157896838186582423u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_10(m, api, true);
        },
        157895738674954212u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_11(m, api, true);
        },
        157899037209838845u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_12(m, api, true);
        },
        157897937698210634u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_13(m, api, true);
        },
        157892440140069579u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_14(m, api, true);
        },
        157891340628441368u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_a_15(m, api, true);
        },
        4878057757827333139u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_1(m, api, true);
        },
        4878058857338961350u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_2(m, api, true);
        },
        4878059956850589561u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_3(m, api, true);
        },
        4878061056362217772u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_4(m, api, true);
        },
        4878062155873845983u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_5(m, api, true);
        },
        4878063255385474194u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_6(m, api, true);
        },
        4878064354897102405u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_7(m, api, true);
        },
        4878065454408730616u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_8(m, api, true);
        },
        4878066553920358827u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_9(m, api, true);
        },
        3100484552619093881u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_10(m, api, true);
        },
        3100483453107465670u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_11(m, api, true);
        },
        3100482353595837459u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_12(m, api, true);
        },
        3100481254084209248u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_13(m, api, true);
        },
        3100488950665606725u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
            script.on_from_c_14(m, api, true);
        },
        3100487851153978514u64 => | script: &mut MainPupScript, params: &[Value], api: &mut ScriptApi<'_>| {
let m = params.get(0)
                            .and_then(|v| serde_json::from_value::<String>(v.clone()).ok())
                            .unwrap_or_default();
