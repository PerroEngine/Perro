...
impl PuptestsTypeTestsTypesPupScript {
    ...
    fn __t_test_dynamic_containers_ops(&mut self, api: &mut ScriptApi<'_>) {
        ...
        let mut __t_map_dyn_val_big: BigInt = self.__t_dynamic_map_inferred.get(String::from("gamma").as_str()).cloned().unwrap_or_default().as_str().map(|s| s.parse::<BigInt>().unwrap_or_default()).unwrap_or_else(|| BigInt::from(self.__t_dynamic_map_inferred.get(String::from("gamma").as_str()).cloned().unwrap_or_default().as_i64().unwrap_or_default()));
        ...
        let temp_api_var_0: Value = self.__t_dynamic_map_inferred.get(String::from("new_decimal").as_str()).cloned().unwrap_or_default(); api.print(format!("{} {}", "Dyn Map Set (new_decimal):", temp_api_var_0.as_str().map(|s| Decimal::from_str(s).unwrap_or_default()).unwrap_or_else(|| rust_decimal::prelude::FromPrimitive::from_f64(temp_api_var_0.as_f64().unwrap_or_default()).unwrap_or_default())));
        ...
        let temp_api_var_0: Value = __t_dyn_map_numeric_key_big.get(&String::from("20")).cloned().unwrap_or_default(); api.print(format!("{} {}", "Dyn Map Num Key Big (20):", temp_api_var_0.as_str().map(|s| s.parse::<BigInt>().unwrap_or_default()).unwrap_or_else(|| BigInt::from(temp_api_var_0.as_i64().unwrap_or_default()))));
        ...
        let temp_api_var_0: Value = __t_dyn_map_numeric_key_decimal.get(&String::from("30.5")).cloned().unwrap_or_default(); api.print(format!("{} {}", "Dyn Map Num Key Dec (30.5):", temp_api_var_0.as_str().map(|s| Decimal::from_str(s).unwrap_or_default()).unwrap_or_else(|| rust_decimal::prelude::FromPrimitive::from_f64(temp_api_var_0.as_f64().unwrap_or_default()).unwrap_or_default())));
    }
    ...
    fn __t_test_static_containers_ops(&mut self, api: &mut ScriptApi<'_>) {
        ...
        let mut __t_map_static_decimal_val: Decimal = self.__t_static_map_string_decimal.get(&String::from("price")).cloned().unwrap_or_default();
        ...
        api.print(format!("{} {}", "Static Array[Entity] super_player_as_entity_from_array name:", /* Cannot perform field access 'entity_name' on array or fixed array */ __t_super_player_as_entity_from_array));
