...
Use `3D Scene Node Templates` when this feature, type group, file format, or workflow appears in game code or assets.
...
script = "res://path/to/script.rs"
    [Sky3D]
        ...
        cloud_variance = 0.38
        wind_vector = (0.1, 0.1)
        cloud_shader = "VOLUMETRIC" # or "WISPY" or "res://path/to/clouds.wgsl"
        star_size = 1.0
        star_scatter = 0.25
        star_gleam = 0.4
        moon_size = 0.6
