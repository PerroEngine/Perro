...
2. Transpiles scripts (Pup → Rust) - typically under 5 seconds
...
- Fast iteration cycle (instant if no changes, ~1–5s for script changes)
...
- ✅ Global decoupled signal system with 500ns dispatch
