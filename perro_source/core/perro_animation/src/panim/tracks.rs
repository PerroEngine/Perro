...
fn apply_light_3d_action(
    ...
    match action {
        ...
        Light3DAction::ShadowStrength(v) => insert_track_key(
            tracks_map,
            object,
            "light3d.shadow_strength",
        ...
        Light3DAction::ShadowDepthBias(v) => insert_track_key(
            tracks_map,
            object,
            "light3d.shadow_depth_bias",
        ...
        Light3DAction::ShadowNormalBias(v) => insert_track_key(
            tracks_map,
            object,
            "light3d.shadow_normal_bias",
