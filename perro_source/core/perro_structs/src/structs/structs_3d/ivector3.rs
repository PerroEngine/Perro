...
mod tests {
    ...
    #[test]
    fn ivector3_negate_matches_negated() {
        let mut v = IVector3::new(3, -4, 5);
        assert_eq!(v.negated(), IVector3::new(-3, 4, -5));
        assert_eq!(v.negate(), &mut IVector3::new(-3, 4, -5));
        assert_eq!(v, IVector3::new(-3, 4, -5));
        assert_eq!(
            IVector3::new(i32::MIN, 1, -2).negated(),
            IVector3::new(i32::MAX, -1, 2)
        );
    }
