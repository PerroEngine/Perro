...
pub mod prelude {
    ...
    pub use crate::{
        ...
        mic_find_device, mic_frame, mic_frame_bytes, mic_get_bytes, mic_get_clip, mic_has_device,
        mic_is_listening, mic_last_error, mic_pack, mic_record, mic_resolve_device, mic_save_wav,
