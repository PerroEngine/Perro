...
pub mod prelude {
    ...
    pub use crate::sub_apis::{
        ...
        PhysicsAPI, PhysicsModule, PhysicsRayHit3D, PreloadedSceneTarget, ProfilingSnapshot,
        QueryExpr, QueryScope, RuntimeMidiModule, SceneAPI, SceneLoadSource, SceneModule,
        ScriptAPI, ScriptModule, SignalAPI, SignalModule, SpatialAudioOptions, TagQuery, TimeAPI,
        TimeModule, WindowAPI, WindowMode, WindowModule, WindowRequest, program,
    };
    pub use crate::{
        ...
        physics_raycast_3d_with_areas, physics_raycast_3d_without_areas, profiling, query,
        ...
        to_local_transform_2d, to_local_transform_3d, window_set_mode, window_set_size,
