...
pub mod prelude {
    pub use crate::{
        ...
        RumbleIntensity, action_cancel_rebind, action_down, action_hash, action_is_rebinding,
        action_pressed, action_rebind_result, action_released, action_start_rebind, gamepad_accel,
