...
pub mod prelude {
    ...
    pub use crate::sub_apis::{
        ...
        IntoScriptMemberID, Member, MeshDataSurfaceHit3D, MeshDataSurfaceRegion3D,
        MeshMaterialRegion3D, MeshSurfaceHit3D, NodeAPI, NodeModule, PhysicsAPI, PhysicsModule,
        PreloadedSceneTarget, QueryExpr, QueryScope, SceneAPI, SceneLoadSource, SceneModule,
        ScriptAPI, ScriptModule, SignalAPI, SignalModule, TagQuery, TimeAPI, TimeModule,
    };
    pub use crate::{
        ...
        delta_time_capped, delta_time_clamped, elapsed_time, fixed_delta_time, force_rerender,
        get_child, get_children, get_global_pos_2d, get_global_pos_3d, get_global_rot_2d,
        get_global_rot_3d, get_global_scale_2d, get_global_scale_3d, get_global_transform_2d,
        get_global_transform_3d, get_local_pos_2d, get_local_pos_3d, get_local_rot_2d,
        get_local_rot_3d, get_local_scale_2d, get_local_scale_3d, get_local_transform_2d,
        get_local_transform_3d, get_node_children_ids, get_node_name, get_node_parent_id,
        get_node_tags, get_node_type, get_var, has_attribute, member, members_with,
        ...
        physics_is_paused, physics_pause, query, query_first, remove_node, reparent,
