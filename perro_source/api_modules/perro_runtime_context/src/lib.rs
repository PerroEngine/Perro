...
pub mod prelude {
    ...
    pub use crate::{
        ...
        scene_load, scene_preload, script_attach, script_detach, set_global_pos_2d,
        ...
        to_local_transform_3d, window_set_mode, window_set_size, window_set_title, with_base_node,
