...
pub fn generate_static_localizations(
    ...
    out.push_str("type RuntimeLocale = perro_api::resource_context::sub_apis::Locale;\n");
...
pub const fn lookup_localized_string(_locale: perro_api::resource_context::sub_apis::Locale, _key_hash: u64) -> &'static str {\n\
    \"\"\n\
}\n",
    )?;
    Ok(())
