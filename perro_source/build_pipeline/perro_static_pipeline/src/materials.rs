...
pub fn generate_static_materials(project_root: &Path) -> Result<(), StaticPipelineError> {
    ...
    out.push_str(
        "use perro_render_bridge::{CustomMaterial3D, CustomMaterialLighting3D, CustomMaterialParam3D, CustomMaterialParamValue3D, Material3D, StandardMaterial3D, ToonMaterial3D, UnlitMaterial3D};\nuse std::borrow::Cow;\n\n",
    );
