...
impl GpuPointParticles3D {
    pub fn new(
        ...
        Self {
            ...
            compute_expr_ops_uploaded: None,
            compute_custom_params_uploaded: None,
            compute_config_uploads: 0,
