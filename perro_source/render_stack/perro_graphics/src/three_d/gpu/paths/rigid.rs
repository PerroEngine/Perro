...
pub(super) fn create_pipeline_rigid(
    device: &wgpu::Device,
    ...
    create_pipeline_rigid_with_depth_write(
        device,
        pipeline_layout,
        shader,
        color_format,
...
pub(super) fn create_pipeline_rigid_blend(
    device: &wgpu::Device,
    pipeline_layout: &wgpu::PipelineLayout,
    shader: &wgpu::ShaderModule,
    color_format: wgpu::TextureFormat,
...
pub(super) fn create_pipeline_overlay_rigid(
    device: &wgpu::Device,
    pipeline_layout: &wgpu::PipelineLayout,
    shader: &wgpu::ShaderModule,
    color_format: wgpu::TextureFormat,
    ...
    device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        label: Some("perro_mesh_pipeline_overlay_rigid"),
        layout: Some(pipeline_layout),
        vertex: wgpu::VertexState {
            module: shader,
            entry_point: Some("vs_main"),
...
pub(super) fn create_depth_prepass_pipeline_rigid(
    device: &wgpu::Device,
    pipeline_layout: &wgpu::PipelineLayout,
    shader: &wgpu::ShaderModule,
    cull_mode: Option<wgpu::Face>,
    ...
    device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        label: Some("perro_depth_prepass_pipeline_rigid"),
        layout: Some(pipeline_layout),
        vertex: wgpu::VertexState {
            module: shader,
            entry_point: Some("vs_main"),
...
pub(super) fn create_shadow_depth_pipeline_rigid(
    ...
    device.create_render_pipeline(&wgpu::RenderPipelineDescriptor {
        label: Some("perro_shadow_depth_pipeline_rigid"),
        layout: Some(pipeline_layout),
        vertex: wgpu::VertexState {
            module: shader,
            entry_point: Some("vs_main"),
