...
pub(super) fn create_pipeline_skinned(
    device: &wgpu::Device,
    ...
    create_pipeline_skinned_with_depth_write(
        device,
        pipeline_layout,
        shader,
        color_format,
...
pub(super) fn create_pipeline_skinned_blend(
    device: &wgpu::Device,
    pipeline_layout: &wgpu::PipelineLayout,
    shader: &wgpu::ShaderModule,
    color_format: wgpu::TextureFormat,
...
pub(super) fn create_pipeline_overlay_skinned(
    device: &wgpu::Device,
    pipeline_layout: &wgpu::PipelineLayout,
    shader: &wgpu::ShaderModule,
    color_format: wgpu::TextureFormat,
...
pub(super) fn create_depth_prepass_pipeline_skinned(
    device: &wgpu::Device,
    pipeline_layout: &wgpu::PipelineLayout,
    shader: &wgpu::ShaderModule,
    cull_mode: Option<wgpu::Face>,
...
pub(super) fn create_shadow_depth_pipeline_skinned(
    device: &wgpu::Device,
    pipeline_layout: &wgpu::PipelineLayout,
    shader: &wgpu::ShaderModule,
    cull_mode: Option<wgpu::Face>,
