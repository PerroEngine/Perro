...
// Ears only resolve the horizontal axis; without HRTF a diagonal source reads
// as nearly centered. Boost x and damp elevation before projecting onto the
// pan sphere so left/right stays legible at oblique angles.
