...
fn internal_step_update(emitter: &mut ParticleEmitter2D, delta_seconds: f32) -> bool {
    let mut emit_finished_signal = false;
...
fn internal_step_fixed_update(_emitter: &mut ParticleEmitter2D, _fixed_delta_seconds: f32) {}

fn non_looping_done_after(emitter: &ParticleEmitter2D, lifetime_max: f32) -> Option<f32> {
