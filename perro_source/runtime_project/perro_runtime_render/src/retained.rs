...
pub struct Render2DState {
    ...
    // Rc, not Arc: the loader channel delivers TileSet2D by value and the
    // wrapper is built + cloned on the main thread only.
    pub tileset_cache: AHashMap<u64, std::rc::Rc<perro_render_bridge::TileSet2D>>,
...
pub struct RenderUiState {
    ...
    pub visible_now: AHashSet<NodeID>,
    pub prev_visible: AHashSet<NodeID>,
    pub removed_visible_scratch: Vec<NodeID>,
...
impl RenderUiState {
    pub fn new() -> Self {
        Self {
            ...
            visible_now: AHashSet::default(),
            prev_visible: AHashSet::default(),
            removed_visible_scratch: Vec::new(),
