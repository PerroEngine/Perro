...
impl SceneFieldName {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Self::SelfModulate => "self_modulate",
            ...
            Self::ShadowSoftness => "shadow_softness",
            Self::ShadowSamples => "shadow_samples",
            Self::Shadow => "shadow",
            Self::ShadowStrength => "shadow_strength",
            Self::ShadowDepthBias => "shadow_depth_bias",
            Self::ShadowNormalBias => "shadow_normal_bias",
            Self::ReceiveShadows => "receive_shadows",
            Self::Color => "color",
            Self::Mesh => "mesh",
            ...
            Self::BlendShapeWeights => "blend_shape_weights",
            Self::BodyA => "body_a",
            Self::BodyB => "body_b",
            ...
            Self::BlendNoiseFactor => "blend_noise_factor",
            Self::BlendNoiseScale => "blend_noise_scale",
            Self::BlendSlopeFactor => "blend_slope_factor",
            Self::BlendStrength => "blend_strength",
            Self::BlendSaltInstances => "blend_salt_instances",
            Self::MinLod => "min_lod",
            Self::MaxLod => "max_lod",
            ...
            Self::HorizonColors => "horizon_colors",
    ...
    pub fn from_borrowed(name: &str) -> Option<Self> {
        Some(match name {
            ...
            "children_modulate" | "child_modulate" => Self::ChildrenModulate,
            "z_index" => Self::ZIndex,
            ...
            "cast_shadows" | "casts_shadows" => Self::CastShadows,
            "shadow_softness" => Self::ShadowSoftness,
            "shadow_samples" => Self::ShadowSamples,
            "shadow" => Self::Shadow,
            "shadow_strength" | "shadow_opacity" => Self::ShadowStrength,
            "shadow_depth_bias" | "shadow_bias" => Self::ShadowDepthBias,
            "shadow_normal_bias" => Self::ShadowNormalBias,
            "receive_shadows" | "receives_shadows" => Self::ReceiveShadows,
            "color" => Self::Color,
            "mesh" => Self::Mesh,
            ...
            "blend_noise_factor" | "blend_noise" => Self::BlendNoiseFactor,
            "blend_noise_scale" => Self::BlendNoiseScale,
            "blend_slope_factor" => Self::BlendSlopeFactor,
            "blend_strength" => Self::BlendStrength,
            "blend_salt_instances" => Self::BlendSaltInstances,
            ...
            "horizon_colors" => Self::HorizonColors,
