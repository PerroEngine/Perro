...
impl SceneFieldName {
    pub fn as_str(&self) -> &str {
        match self {
            ...
            Self::CloudShader => "cloud_shader",
            Self::SunShader => "sun_shader",
            Self::MoonShader => "moon_shader",
            Self::Fill => "fill",
            Self::Stroke => "stroke",
    ...
    pub fn from_borrowed(name: &str) -> Option<Self> {
        Some(match name {
            ...
            "cloud_shader" | "clouds_shader" => Self::CloudShader,
            "sun_shader" => Self::SunShader,
            "moon_shader" => Self::MoonShader,
            "fill" => Self::Fill,
            "stroke" => Self::Stroke,
            _ => return None,
        })
