...
fn resolve_scene_sky3d_field(field: &SceneFieldName) -> Option<Sky3DField> {
    match field {
        ...
        SceneFieldName::CloudShader => Some(Sky3DField::CloudShader),
        SceneFieldName::SunShader => Some(Sky3DField::SunShader),
        SceneFieldName::MoonShader => Some(Sky3DField::MoonShader),
...
fn resolve_sky3d_field(field: &str) -> Option<Sky3DField> {
    match field {
        ...
        "cloud_shader" | "clouds_shader" | "clouds.shader" => Some(Sky3DField::CloudShader),
        "sun_shader" | "sun.shader" => Some(Sky3DField::SunShader),
        "moon_shader" | "moon.shader" => Some(Sky3DField::MoonShader),
