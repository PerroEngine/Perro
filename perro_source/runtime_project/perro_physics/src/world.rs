...
impl PhysicsWorld2D {
    pub fn new() -> Self {
        ...
        Self {
            ...
            gravity: r2::Vector::new(0.0, -9.81),
            integration_parameters,
            islands: r2::IslandManager::new(),
            broad_phase: r2::DefaultBroadPhase::new(),
            query_bvh: rapier2d::parry::partitioning::Bvh::new(),
...
impl PhysicsWorld3D {
    pub fn new() -> Self {
        ...
        Self {
            ...
            query_bvh: rapier3d::parry::partitioning::Bvh::new(),
